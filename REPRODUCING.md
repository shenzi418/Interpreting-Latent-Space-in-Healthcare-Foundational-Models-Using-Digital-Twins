...
python analysis/block_transfer.py        # block transfer: Table 4.11, Figure 4.3    -> f2_blocks.json
...
| `analysis/channel_repair.py` (+ `_verify`) | Table 4.12, Figure 4.4 (repair) | `results/f3_repair.json` |
