...
```
python analysis/fidelity_audit.py        # audit: thesis Tables 4.9-4.10, Figure 4.1  -> f1_fidelity.json
python analysis/block_transfer.py        # block transfer: Table 4.11, Figure 4.2    -> f2_blocks.json
...
| `analysis/channel_repair.py` (+ `_verify`) | Table 4.12, Figure 4.3 (repair) | `results/f3_repair.json` |
