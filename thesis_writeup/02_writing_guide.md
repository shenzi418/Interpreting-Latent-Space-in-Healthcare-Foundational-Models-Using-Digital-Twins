...
| **Parenthetical asides** as the default way to embed an example or qualification (owner rule, 2026-08-25) | Give the example its own short sentence, or attach it with "which means" / "for X this means". Parentheses stay for citations, cross-references and units; prose asides in brackets read as generated when frequent. |
